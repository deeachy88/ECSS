...
#Report
    ...
    path('ec_renewal_report_form', views.ec_renewal_report_form, name='ec_renewal_report_form'),
    path('view_ec_renewal_list', views.view_ec_renewal_list, name='view_ec_renewal_list'),
    ...
    path('tor_report_form', views.tor_report_form, name='tor_report_form'),
    path('view_tor_list', views.view_tor_list, name='view_tor_list'),
    ...
    path('tor_pending_report_form', views.tor_pending_report_form, name='tor_pending_report_form'),
    path('tor_pending_list', views.tor_pending_list, name='tor_pending_list'),
