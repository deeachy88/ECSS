...
urlpatterns = [
    ...
    path('save_anc_general_attachment', views.save_general_attachment, name='save_anc_general_attachment'),
    path('save_anc_general_attachment_details', views.save_general_attachment_details, name='save_anc_general_attachment_details'),
